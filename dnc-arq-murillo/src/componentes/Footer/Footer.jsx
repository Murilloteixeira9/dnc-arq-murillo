            ...
            <div className="container">
                <div className="d-flex jc-space-between mobile-fd-column">
                    <div className="footer-logo-col">
                        ...
                        <div className="d-flex social-links">
                            ...
                            <a href="https://www.x.com/?locale=pt_BR" target="_blank">
                                <img src={TwitterIcon} />
                            </a>
                            <a href="https://www.linkedin.com/?locale=pt_BR" target="_blank">
                                <img src={LinkedinIcon} />
                            </a>
                            <a href="https://www.instagram.com/?locale=pt_BR" target="_blank">
                    ...
                    <div className="d-flex mobile-fd-column">
                        ...
                        <div className="footer-col">
                            ...
                            <p className="gray">(19) 99187-4342</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="d-flex jc-space-between footer-copy">
                    ...
                    <div className="langs-area d-flex">
                        <img src={BrazilIcon} height="29px" onClick={() => changeLanguage("br")} />
                        <img src={UsaIcon} height="29px" onClick={() => changeLanguage("en")} />
                    </div>
                </div>
            </div>
        </footer>
