  ...
  const handleSavedProjects = (id) => {
    setFavProjects((prevFavProjects) => {
      if (prevFavProjects.includes(id)) {
        const updatedFavs = prevFavProjects.filter((projectId) => projectId !== id)
        sessionStorage.setItem("favProjects", JSON.stringify(updatedFavs))
        return updatedFavs
      } else {
        const updatedFavs = [...prevFavProjects, id]
        sessionStorage.setItem("favProjects", JSON.stringify(updatedFavs))
        return updatedFavs
      }
    })
